...
/*Location test, neighbor, userInput;

    test.iterationBegin();

    neighbor = test.iterationCurrent();
    neighbor.iterationAdvance();
    if(neighbor.iterationDone()){
        cout << "Should not be seeing this message." << endl;
    }
    else{
        cout << "Iteration not compelte" << endl;
    }
    ...
    if(test == neighbor){
        ...
        cout << "These two are not the same location." << endl;
    }

    cout << "Location of test is: " << test << endl; //should be 0 0
    cout << "Location of neighbor is : " << neighbor << endl; //should be 0 1

    cout << "Input a location: " << endl;
    cin >> userInput;
    cout << "Location of user input is: " << userInput << endl; */